...
export const SPONSORS_DATA: SponsorItem[] = [
  {
    id: 'sponsor-jobien',
    name: 'Caffe Jö Bien (Acısu)',
    shortName: 'Caffe Jö Bien',
    category: 'Mekan & Açık Hava Buluşmaları',
    description: 'İzmit Tepecik Mahallesi Acısu Parkı içerisindeki ferah açık hava bahçesi ve samimi atmosferiyle gençlik buluşmalarımıza ev sahipliği yapan mekan destekçimiz.',
    badge: 'Mekan Partneri',
    location: 'İzmit / Tepecik Mah. Acısu Parkı',
    perks: 'Topluluk buluşmalarında özel açık alan rezervasyonu ve üyelere özel sıcak içecek desteği',
    isPrimary: true,
    iconType: 'cafe'
  },
  {
    id: 'sponsor-pureblack',
    name: 'Pure Black Coffee',
    shortName: 'Pure Black',
    category: '3. Nesil Nitelikli Kahve',
    description: 'İzmit Yahyakaptan, Kent Meydanı ve Umuttepe lokasyonlarında nitelikli taze kavrum kahveleriyle konuşma kulübü ve etkinliklerimizin lezzet ortağı.',
    badge: 'Kahve Partneri',
    location: 'İzmit (Yahyakaptan, Kent Meydanı, Umuttepe)',
    perks: 'Speaking Club ve atölye katılımcılarına özel menü indirimi ve etkinlik kahvesi ikramı',
    isPrimary: true,
    iconType: 'cafe'
  },
  {
    id: 'sponsor-kartepe',
    name: 'Kartepe Doğa & Outdoor',
    shortName: 'Kartepe Outdoor',
    category: 'Doğa & Ekipman Desteği',
    description: 'Hiking rotalarında güvenlik rehberliği ve kamp etkinliklerimizde malzeme desteği sunan yerel doğa kulübü.',
    badge: 'Ekipman Desteği',
    location: 'Kartepe / Maşukiye',
    perks: 'Topluluk üyelerine kamp çadırı, baton ve outdoor malzeme kiralamalarında indirim',
    isPrimary: false,
    iconType: 'nature'
  },
  {
    id: 'sponsor-sanat',
    name: 'İzmit Sanat & Seramik Atölyesi',
    shortName: 'İzmit Sanat',
    category: 'Atölye & Malzeme Desteği',
    description: 'Biblo, bez çanta ve kil boyama çalışmalarımızda kaliteli boya, fırça ve seramik kili tedarikçisi.',
    badge: 'Sanat Destekçisi',
    location: 'İzmit / Karabaş Mah.',
    perks: 'Topluluk atölyelerinde fırınlama ve ham seramik malzemelerinde toptan maliyet avantajı',
    isPrimary: false,
    iconType: 'art'
  },
  {
    id: 'sponsor-seka',
    name: 'Seka Kitap & Kahve Evi',
    shortName: 'Seka Kitap Evi',
    category: 'Kültür & Kitap Kulübü Partneri',
    description: 'Seka Park sahilinde kitap söyleşilerimiz için sakin kütüphane köşesi ve edebiyat sohbeti ortamı sağlayan partnerimiz.',
    badge: 'Kültür Ortağı',
    location: 'İzmit / Seka Park',
    perks: 'Kitap kulübü buluşmalarında sessiz okuma alanı ve yazar söyleşisi desteği',
    isPrimary: false,
    iconType: 'culture'
  },
  {
    id: 'sponsor-genc',
    name: 'Kocaeli Gençlik İnisiyatifi',
    shortName: 'Kocaeli Gençlik',
    category: 'Sivil Dayanışma & İletişim',
    description: 'Kocaeli Üniversitesi öğrencileri ile kentteki yeni mezunlar arasında sosyal köprü kuran bağımsız gençlik platformu.',
    badge: 'Dayanışma Partneri',
    location: 'Kocaeli Geneli',
    perks: 'Topluluk etkinliklerinin üniversite ve öğrenci kulüpleri arasında geniş duyurumu',
    isPrimary: false,
    iconType: 'youth'
  }
];
